...
<body>
    <!--<header class="topo">
        <div class="menu">
            <script>
                function voltar(){
                    window.location.href="<?php echo e(route('welcome')); ?>";
                }
            </script>
    ...
    <header class="topo">
        <div class="menu">
            ...
            <a href="<?php echo e(route('welcome')); ?>" id="voltar" class="voltar">
...
</html><?php /**PATH C:\xampp\htdocs\projeto-web\resources\views/login/index.blade.php ENDPATH**/ ?>